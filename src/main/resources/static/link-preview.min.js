  ...
  (function(self2) {
    var irrelevant = function(exports2) {
      ...
      function Response(bodyInit, options3) {
        ...
        this.type = "default";
        this.status = options3.status === undefined ? 200 : options3.status;
        this.ok = this.status >= 200 && this.status < 300;
        this.statusText = "statusText" in options3 ? options3.statusText : "OK";
        this.headers = new Headers(options3.headers);
...
function prop(name, value) {
  ...
  if (typeof name === "string" && value === undefined) {
    switch (name) {
      ...
      case "nodeName": {
        const el = this[0];
        return isTag2(el) ? el.name.toUpperCase() : undefined;
      }
      case "href":
      case "src": {
        const el = this[0];
...
var import_abort_controller = __toESM(require_browser(), 1);
...
var I = function(s, o, t) {
  if (s && K(s) && s instanceof m)
    return s;
  var r = new m;
  return r.parse(s, o, t), r;
};
var it = function(s) {
  return Z(s) && (s = I(s)), s instanceof m ? s.format() : m.prototype.format.call(s);
};
var ft = function(s, o) {
  return I(s, false, true).resolve(o);
};
var ut = function(s, o) {
  return s ? I(s, false, true).resolveObject(o) : o;
};
var { URL: J, URLSearchParams: Q, [Symbol.for("Bun.lazy")]: T } = globalThis;
var tt = /^([a-z0-9.+-]+:)/i;
var st = /:[0-9]*$/;
var ht = /^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/;
var et = ["<", ">", '"', "`", " ", "\r", `
...
var A = { http: true, https: true, ftp: true, gopher: true, file: true, "http:": true, "https:": true, "ftp:": true, "gopher:": true, "file:": true };
var S = { parse(s) {
  var o = decodeURIComponent;
  return (s + "").replace(/\+/g, " ").split("&").filter(Boolean).reduce(function(t, r, a) {
    var l = r.split("="), f = o(l[0] || ""), h = o(l[1] || ""), y = t[f];
    return t[f] = y === undefined ? h : [].concat(y, h), t;
  }, {});
}, stringify(s) {
  var o = encodeURIComponent;
  return Object.keys(s || {}).reduce(function(t, r) {
    return [].concat(s[r]).forEach(function(a) {
      t.push(o(r) + "=" + o(a));
    }), t;
  }, []).join("&").replace(/\s/g, "+");
} };
m.prototype.parse = function(s, o, t) {
  ...
  var r = s.indexOf("?"), a = r !== -1 && r < s.indexOf("#") ? "?" : "#", l = s.split(a), f = /\\/g;
  l[0] = l[0].replace(f, "/"), s = l.join(a);
  var h = s;
  if (h = h.trim(), !t && s.split("#").length === 1) {
    var y = ht.exec(h);
    if (y)
      return this.path = h, this.href = h, this.pathname = y[1], y[2] ? (this.search = y[2], o ? this.query = S.parse(this.search.substr(1)) : this.query = this.search.substr(1)) : o && (this.search = "", this.query = {}), this;
  }
  var c = tt.exec(h);
  if (c) {
    c = c[0];
  ...
  if (t || c || h.match(/^\/\/[^@\/]+@[^@\/]+/)) {
    var R = h.substr(0, 2) === "//";
    R && !(c && N[c]) && (h = h.substr(2), this.slashes = true);
  }
  if (!N[c] && (R || c && !A[c])) {
    ...
    if (!C)
      for (var e = this.hostname.split(/\./), n = 0, i = e.length;n < i; n++) {
        var x = e[n];
        if (!!x && !x.match(G)) {
          for (var g = "", d = 0, w = x.length;d < w; d++)
            x.charCodeAt(d) > 127 ? g += "x" : g += x[d];
          if (!g.match(G)) {
            var q = e.slice(0, n), O = e.slice(n + 1), U = x.match(at);
            U && (q.push(U[1]), O.unshift(U[2])), O.length && (h = "/" + O.join(".") + h), this.hostname = q.join(".");
            break;
          }
        }
      }
    this.hostname.length > rt ? this.hostname = "" : this.hostname = this.hostname.toLowerCase(), C || (this.hostname = new J(`https://${this.hostname}`).hostname);
    var z = this.port ? ":" + this.port : "", k = this.hostname || "";
    this.host = k + z, this.href += this.host, C && (this.hostname = this.hostname.substr(1, this.hostname.length - 2), h[0] !== "/" && (h = "/" + h));
  }
  if (!nt[v])
    for (var n = 0, i = B.length;n < i; n++) {
      var P = B[n];
      if (h.indexOf(P) !== -1) {
        var $2 = encodeURIComponent(P);
        $2 === P && ($2 = escape(P)), h = h.split(P).join($2);
      }
    }
  var F = h.indexOf("#");
  F !== -1 && (this.hash = h.substr(F), h = h.slice(0, F));
  var L = h.indexOf("?");
  if (L !== -1 ? (this.search = h.substr(L), this.query = h.substr(L + 1), o && (this.query = S.parse(this.query)), h = h.slice(0, L)) : o && (this.search = "", this.query = {}), h && (this.pathname = h), A[v] && this.hostname && !this.pathname && (this.pathname = "/"), this.pathname || this.search) {
    var z = this.pathname || "", H = this.search || "";
    this.path = z + H;
  }
...
m.prototype.format = function() {
  ...
  var o = this.protocol || "", t = this.pathname || "", r = this.hash || "", a = false, l = "";
  this.host ? a = s + this.host : this.hostname && (a = s + (this.hostname.indexOf(":") === -1 ? this.hostname : "[" + this.hostname + "]"), this.port && (a += ":" + this.port)), this.query && K(this.query) && Object.keys(this.query).length && (l = S.stringify(this.query));
  var f = this.search || l && "?" + l || "";
  return o && o.substr(-1) !== ":" && (o += ":"), this.slashes || (!o || A[o]) && a !== false ? (a = "//" + (a || ""), t && t.charAt(0) !== "/" && (t = "/" + t)) : a || (a = ""), r && r.charAt(0) !== "#" && (r = "#" + r), f && f.charAt(0) !== "?" && (f = "?" + f), t = t.replace(/[?#]/g, function(h) {
    return encodeURIComponent(h);
  }), f = f.replace("#", "%23"), o + a + t + f + r;
};
...
m.prototype.resolveObject = function(s) {
  if (Z(s)) {
    var o = new m;
    o.parse(s, false, true), s = o;
  }
  for (var t = new m, r = Object.keys(this), a = 0;a < r.length; a++) {
    var l = r[a];
    t[l] = this[l];
  }
  ...
  var b = t.pathname && t.pathname.charAt(0) === "/", j = s.host || s.pathname && s.pathname.charAt(0) === "/", p = j || b || t.host && s.pathname, C = p, e = t.pathname && t.pathname.split("/") || [], i = s.pathname && s.pathname.split("/") || [], x = t.protocol && !A[t.protocol];
  if (x && (t.hostname = "", t.port = null, t.host && (e[0] === "" ? e[0] = t.host : e.unshift(t.host)), t.host = "", s.protocol && (s.hostname = null, s.port = null, s.host && (i[0] === "" ? i[0] = s.host : i.unshift(s.host)), s.host = null), p = p && (i[0] === "" || e[0] === "")), j)
    ...
    return t.search = s.search, t.query = s.query, (!_(t.pathname) || !_(t.search)) && (t.path = (t.pathname ? t.pathname : "") + (t.search ? t.search : "")), t.href = t.format(), t;
  }
  if (!e.length)
    return t.pathname = null, t.search ? t.path = "/" + t.search : t.path = null, t.href = t.format(), t;
  for (var d = e.slice(-1)[0], w = (t.host || s.host || e.length > 1) && (d === "." || d === "..") || d === "", q = 0, O = e.length;O >= 0; O--)
    d = e[O], d === "." ? e.splice(O, 1) : d === ".." ? (e.splice(O, 1), q++) : q && (e.splice(O, 1), q--);
  if (!p && !C)
    for (;q--; q)
      e.unshift("..");
  p && e[0] !== "" && (!e[0] || e[0].charAt(0) !== "/") && e.unshift(""), w && e.join("/").substr(-1) !== "/" && e.push("");
  ...
  return p = p || t.host && e.length, p && !U && e.unshift(""), e.length ? t.pathname = e.join("/") : (t.pathname = null, t.path = null), (!_(t.pathname) || !_(t.search)) && (t.path = (t.pathname ? t.pathname : "") + (t.search ? t.search : "")), t.auth = s.auth || t.auth, t.slashes = t.slashes || s.slashes, t.href = t.format(), t;
};
m.prototype.parseHost = function() {
  var s = this.host, o = st.exec(s);
  o && (o = o[0], o !== ":" && (this.port = o.substr(1)), s = s.substr(0, s.length - o.length)), s && (this.hostname = s);
};
var V;
var W;
var X;
var Y;
T && (V = T("pathToFileURL"), W = T("fileURLToPath"), X = T("domainToASCII"), Y = T("domainToUnicode"));
var ct = { parse: I, resolve: ft, resolveObject: ut, format: it, Url: m, pathToFileURL: V, fileURLToPath: W, domainToASCII: X, domainToUnicode: Y, URL: J, URLSearchParams: Q };
...
// index.ts
var throwOnLoopback = function(address) {
  if (CONSTANTS.REGEX_LOOPBACK.test(address)) {
    throw new Error("SSRF request detected, trying to query host");
  }
};
var metaTag = function(doc, type, attr2) {
  const nodes = doc(`meta[${attr2}='${type}']`);
  return nodes.length ? nodes : null;
};
var metaTagContent = function(doc, type, attr2) {
  return doc(`meta[${attr2}='${type}']`).attr(`content`);
};
...
var getMediaType = function(doc) {
  const node3 = metaTag(doc, `medium`, `name`);
  if (node3) {
    const content = node3.attr(`content`);
    return content === `image` ? `photo` : content;
  }
  return metaTagContent(doc, `og:type`, `property`) || metaTagContent(doc, `og:type`, `name`);
};
var getImages = function(doc, rootUrl, imagesPropertyType) {
  let images = [];
  let nodes;
  let src;
  let dic = {};
  ...
  if (nodes) {
    nodes.each((_2, node3) => {
      if (node3.type === `tag`) {
        src = node3.attribs.content;
        if (src) {
          src = ct.resolve(rootUrl, src);
          images.push(src);
        }
      }
    });
  ...
  if (images.length <= 0 && !imagesPropertyType) {
    ...
    if (src) {
      ...
      if (nodes?.length) {
        ...
        nodes.each((_2, node3) => {
          if (node3.type === `tag`)
            src = node3.attribs.src;
          if (src && !dic[src]) {
            dic[src] = true;
            images.push(ct.resolve(rootUrl, src));
          }
        });
      }
    }
...
var getVideos = function(doc) {
  ...
  if (nodes?.length) {
    ...
    for (index2 = 0;index2 < nodes.length; index2 += 1) {
      const node3 = nodes[index2];
      if (node3.type === `tag`)
        video = node3.attribs.content;
      nodeType = nodeTypes?.[index2];
      if (nodeType?.type === `tag`) {
        videoType = nodeType ? nodeType.attribs.content : null;
      }
      nodeSecureUrl = nodeSecureUrls?.[index2];
...
var getDefaultFavicon = function(rootUrl) {
  return ct.resolve(rootUrl, `/favicon.ico`);
};
var getFavicons = function(doc, rootUrl) {
  const images = [];
  let nodes = [];
  let src;
  const relSelectors = [
...
var parseImageResponse = function(url, contentType) {
  return {
    url,
    mediaType: `image`,
    contentType,
...
var parseAudioResponse = function(url, contentType) {
  return {
    url,
    mediaType: `audio`,
    contentType,
...
var parseVideoResponse = function(url, contentType) {
  return {
    url,
    mediaType: `video`,
    contentType,
...
var parseApplicationResponse = function(url, contentType) {
  return {
    url,
...
var parseTextResponse = function(body, url, options3 = {}, contentType) {
  const doc = esm_default2.load(body);
  return {
    url,
    title: getTitle(doc),
    ...
    contentType,
    images: getImages(doc, url, options3.imagesPropertyType),
    videos: getVideos(doc),
    favicons: getFavicons(doc, url)
  };
};
var parseUnknownResponse = function(body, url, options3 = {}, contentType) {
  return parseTextResponse(body, url, options3, contentType);
};
var parseResponse = function(response, options3) {
  try {
    let contentType = response.headers[`content-type`];
    let contentTypeTokens = [];
    let charset = null;
    if (!contentType) {
      return parseUnknownResponse(response.data, response.url, options3);
    }
    if (contentType.includes(`;`)) {
      contentTypeTokens = contentType.split(`;`);
      contentType = contentTypeTokens[0];
      for (let token3 of contentTypeTokens) {
        if (token3.indexOf("charset=") !== -1) {
          charset = token3.split("=")[1];
        }
      }
    }
    ...
    if (CONSTANTS.REGEX_CONTENT_TYPE_TEXT.test(contentType)) {
      const htmlString2 = response.data;
      return {
        ...parseTextResponse(htmlString2, response.url, options3, contentType),
        charset
      };
    }
    ...
    return {
      ...parseUnknownResponse(htmlString, response.url, options3),
      charset
    };
  } catch (e) {
...
async function getLinkPreview(text3, options3) {
  if (!text3 || typeof text3 !== `string`) {
    throw new Error(`link-preview-js did not receive a valid url or text`);
  }
  const detectedUrl = text3.replace(/\n/g, ` `).split(` `).find((token3) => CONSTANTS.REGEX_VALID_URL.test(token3));
  if (!detectedUrl) {
    throw new Error(`link-preview-js did not receive a valid a url or text`);
  }
  if (options3?.followRedirects === `manual` && !options3?.handleRedirects) {
    throw new Error(`link-preview-js followRedirects is set to manual, but no handleRedirects function was provided`);
  }
  if (!!options3?.resolveDNSHost) {
    const resolvedUrl = await options3.resolveDNSHost(detectedUrl);
    throwOnLoopback(resolvedUrl);
  }
  const timeout = options3?.timeout ?? 3000;
  ...
  const fetchOptions = {
    ...
    redirect: options3?.followRedirects ?? `error`,
    signal: controller.signal
  };
  const fetchUrl = options3?.proxyUrl ? options3.proxyUrl.concat(detectedUrl) : detectedUrl;
  let response = await import_cross_fetch.fetch(fetchUrl, fetchOptions).catch((e) => {
  ...
  if (response.status > 300 && response.status < 309 && fetchOptions.redirect === `manual` && options3?.handleRedirects) {
    const forwardedUrl = response.headers.get(`location`) || ``;
    if (!options3.handleRedirects(fetchUrl, forwardedUrl)) {
      throw new Error(`link-preview-js could not handle redirect`);
    }
    if (!!options3?.resolveDNSHost) {
      const resolvedUrl = await options3.resolveDNSHost(forwardedUrl);
      throwOnLoopback(resolvedUrl);
    }
    response = await import_cross_fetch.fetch(forwardedUrl, fetchOptions);
  }
  clearTimeout(timeoutCounter);
  const headers = {};
  ...
  const normalizedResponse = {
    url: options3?.proxyUrl ? response.url.replace(options3.proxyUrl, ``) : response.url,
    headers,
    data: await response.text()
  };
  return parseResponse(normalizedResponse, options3);
}
async function getPreviewFromContent(response, options3) {
  ...
  return parseResponse(response, options3);
}
export {
